...
| ----------- | ----------------------------------------------- | --------------------------------------- |
| Web         | [cleverbear57](https://github.com/cleverbear57) | [Vexcited](https://github.com/Vexcited) |

> I made a new note taking app using Supabase! \
> Its so secure, I put my flag as the password to the `admin` account. \
> I even put my anonymous key somewhere in the site. \
> The password database is called `users`.

## Solution

![login/signup page of the challenge](assets/imaginary_notes.png)
