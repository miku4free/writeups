...
| ----------- | ----------------------------------- | --------------------------------------- |
| Crypto      | [Eth007](https://github.com/Eth007) | [Vexcited](https://github.com/Vexcited) |

> wait, i thought XORing something with itself gives all 0s???

## Solution

![attached image with the challenge](assets/redacted.png)
...
We know the prefix is `ictf{` and the end is `}`, let's bruteforce.
