...
| ----------- | ---------- | --------------------------------------- |
| Forensics   | Ciaran     | [Vexcited](https://github.com/Vexcited) |

> The frontend has gone down but the store is still open, can you buy the flag? \
> [`capture.pcap` file](assets/thrift_store_capture.pcap) is attached.

## Solution

### Opening in Wireshark

![alt text](assets/thrift_wireshark.png)
...
>
> _Taken from <https://thrift.apache.org/>._
...
![alt text](assets/thrift_addtobasket_call.png)
...
![payment reply](assets/thrift_pay_reply.png)
...
![add to basket reply](assets/thrift_addtobasket_reply.png)
